...
/**
 * SafeSelectContent - Version sans Portal pour éviter les erreurs de removeChild
 * Utilisé dans les composants qui peuvent être démontés rapidement (wizard, steps, modals)
 */
